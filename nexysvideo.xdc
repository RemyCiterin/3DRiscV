...
set_property -dict {PACKAGE_PIN W20 IOSTANDARD LVCMOS33} [get_ports sd_mosi] # sd_cmd
...
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {sd_miso}] # sd_d[0]
...
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports sd_cs] # sd_d[3]
